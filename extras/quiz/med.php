...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=1";
...
echo "</p><hr/><p class=\"break\">$breaker$hyback <a href=\"./index.php?ses=$ses&amp;act=index\">back</a><br/>
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=2";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=3";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=4";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=5";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=6";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=7";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=8";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=9";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
...
$query = "SELECT * FROM waamp_quiz WHERE difficulty='med' AND number=10";
$result = mysql_query("$query");
$num_rows = mysql_num_rows($result);
$row = mysql_fetch_array($result);
