...
$query ="INSERT INTO phoenix_wap ( owner, title, sysname, content, date, type ) values ( '$owner', 'System', '$pagename', '(b)$login(/b) entered $tittie!', now(), 'chat' )";
mysql_query($query);
...
{
$mg = urlencode("You are not logged in, please log in, then you can access chat.");
